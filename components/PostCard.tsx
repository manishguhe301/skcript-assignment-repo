...
export const PostCard = ({ post }: { post: Post }) => {
  return (
    <div
      className='p-[10px] rounded-[0.375rem] bg-[#fff] cursor-pointer border border-[#E2E2E2] hover:border-[#E8E8E8] transition-all duration-100 hover:bg-gray-50 flex items-center gap-2'
      key={post.id}
    >
